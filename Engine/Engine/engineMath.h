...
{
	// TODO Lab 01e
	Vector4 temp = Vector4(vec.x, vec.y, vec.z, w);

	Vector3 ret;
	ret.x = (temp.x * mat.mat[0][0]) + (temp.y * mat.mat[1][0]) + (temp.z * mat.mat[2][0]) + (temp.w * mat.mat[3][0]);
	ret.y = (temp.x * mat.mat[0][1]) + (temp.y * mat.mat[1][1]) + (temp.z * mat.mat[2][1]) + (temp.w * mat.mat[3][1]);
	ret.z = (temp.x * mat.mat[0][2]) + (temp.y * mat.mat[1][2]) + (temp.z * mat.mat[2][2]) + (temp.w * mat.mat[3][2]);
	return ret;
}
...
inline Vector4 Transform(const Vector4& vec, const Matrix4& mat)
{
	...
	ret.y = (temp.x * mat.mat[0][1]) + (temp.y * mat.mat[1][1]) + (temp.z * mat.mat[2][1]) + (temp.w * mat.mat[3][1]);
	ret.z = (temp.x * mat.mat[0][2]) + (temp.y * mat.mat[1][2]) + (temp.z * mat.mat[2][2]) + (temp.w * mat.mat[3][2]);
	ret.w = (temp.x * mat.mat[0][3]) + (temp.y * mat.mat[1][3]) + (temp.z * mat.mat[2][3]) + (temp.w * mat.mat[3][3]);
	return ret;
}
