...
public:
    ...
    {
        // DONE Lab 01g
		SIMDVector3 ret = LengthSq_v();
		return ret.mVec.m128_f32[0];
    }
    ...
    {
        // DONE Lab 01g
		SIMDVector3 ret = SIMDVector3(_mm_dp_ps(mVec, mVec, 0x77));
		ret = SIMDVector3(_mm_sqrt_ps(ret.mVec));
		return ret;
    }
    ...
    {
        // DONE Lab 01g
		return Length_v().mVec.m128_f32[0];
    }
    ...
    friend SIMDVector3 Normalize(const SIMDVector3& vec)
    {
		...
		temp = _mm_rsqrt_ps(temp);
		SIMDVector3 ret = SIMDVector3(_mm_mul_ps(vec.mVec, temp));
		return ret;
    }
    ...
    {
        // DONE Lab 01g
		SIMDVector3 ret = SIMDVector3(_mm_dp_ps(a.mVec, b.mVec, 0x7F));
        return ret.mVec.m128_f32[0];
    }
    ...
    friend SIMDVector3 Cross(const SIMDVector3& a, const SIMDVector3& b)
    {
		...
		SIMDVector3 AA = SIMDVector3(tempA);

		__m128 tempB = _mm_shuffle_ps(b.mVec, b.mVec, _MM_SHUFFLER(2, 0, 1, 3));
		SIMDVector3 BB = SIMDVector3(tempB);

		SIMDVector3 result = AA * BB;
		AA.mVec = _mm_shuffle_ps(a.mVec, a.mVec, _MM_SHUFFLER(2, 0, 1, 3));
		BB.mVec = _mm_shuffle_ps(b.mVec, b.mVec, _MM_SHUFFLER(1, 2, 0, 3));
		AA = AA * BB;
		result -= AA;
    ...
    {
        // DONE Lab 01g
		SIMDVector3 vecTo = b - a;
		vecTo *= f;
		SIMDVector3 ret = a + vecTo;
		return ret;
    }
...
public:
    ...
    {
        // DONE Lab 01h
        return SIMDVector4(_mm_dp_ps(mVec, mVec, 0xF8));
    }
    ...
    {
        // DONE Lab 01h
		SIMDVector4 ret = LengthSq_v();
        return ret.mVec.m128_f32[3];
    }
    ...
    {
        // DONE Lab 01h
		SIMDVector4 ret = SIMDVector4(_mm_dp_ps(mVec, mVec, 0xF8));
		ret = SIMDVector4(_mm_sqrt_ps(ret.mVec));
		return ret;
    }
    ...
    {
        // DONE Lab 01h
		return Length_v().mVec.m128_f32[3];
    }
    ...
    friend SIMDVector4 Normalize(const SIMDVector4& vec)
    {
		...
		temp = _mm_shuffle_ps(temp, temp, _MM_SHUFFLER(3, 3, 3, 3));
		temp = _mm_rsqrt_ps(temp);
		SIMDVector4 ret = SIMDVector4(_mm_mul_ps(vec.mVec, temp));
		return ret;
    }
    ...
    {
        // DONE Lab 01h
		return SIMDVector4(_mm_dp_ps(a.mVec, b.mVec, 0xF8));
    }
    ...
    {
        // DONE Lab 01h
		SIMDVector4 ret = SIMDVector4(_mm_dp_ps(a.mVec, b.mVec, 0xF8));
		return ret.mVec.m128_f32[3];
    }
    ...
    friend SIMDVector4 Cross(const SIMDVector4& a, const SIMDVector4& b)
    {
        // DONE Lab 01h
		__m128 tempA = _mm_shuffle_ps(a.mVec, a.mVec, _MM_SHUFFLER(1, 2, 0, 3));
		SIMDVector4 AA = SIMDVector4(tempA);

		__m128 tempB = _mm_shuffle_ps(b.mVec, b.mVec, _MM_SHUFFLER(2, 0, 1, 3));
		SIMDVector4 BB = SIMDVector4(tempB);

		SIMDVector4 result = AA * BB;
		AA.mVec = _mm_shuffle_ps(a.mVec, a.mVec, _MM_SHUFFLER(2, 0, 1, 3));
		BB.mVec = _mm_shuffle_ps(b.mVec, b.mVec, _MM_SHUFFLER(1, 2, 0, 3));
		AA = AA * BB;
		result -= AA;
		return SIMDVector4(result);
    }
    ...
    {
        // TODO Lab 01h
		SIMDVector4 vecTo = b - a;
		vecTo *= f;
		SIMDVector4 ret = a + vecTo;
		return ret;
    }
